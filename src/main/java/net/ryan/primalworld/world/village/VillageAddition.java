package net.ryan.primalworld.world.village;
...
@Mod.EventBusSubscriber(modid = primalworld.MOD_ID)
public class VillageAddition {
    ...
    public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
        ...
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ...
                "primalworld:paleontologist_house", 250);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/savanna/houses"),
                "primalworld:paleontologist_house_savanna", 50);
        //
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/snowy/houses"),
                "primalworld:paleontologist_house_snowy", 25);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/taiga/houses"),
                "primalworld:paleontologist_house_taiga", 50);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/desert/houses"),
                "primalworld:paleontologist_house_desert", 125);
    }
}